...
public class Tabla
{
    ...
    /**
     * Constructor de la activity_usuario_lista_apertura
     * @param UsuarioListaApertura Actividad donde va a estar la tabla
     * @param activity_usuario_lista_apertura TableLayout donde se pintará la tabla
     */
    public Tabla(Activity UsuarioListaApertura, TableLayout activity_usuario_lista_apertura)
    {
        this.actividad = UsuarioListaApertura;
        this.tabla = activity_usuario_lista_apertura;
